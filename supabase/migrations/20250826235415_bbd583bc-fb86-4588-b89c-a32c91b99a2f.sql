-- Add missing e-commerce and shop features to the work tracker
...
((SELECT id FROM features WHERE name = 'Content Management System'), 
 ...
 'completed', 'medium', 3, 5, '2024-12-18'),
