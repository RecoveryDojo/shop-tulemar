...
BEGIN
    ...
    (project_uuid, 'Database Integration & Migration', 'Set up Supabase database with products, categories, and orders tables with proper relationships and RLS policies', 'critical', 8, 8, 100),
    (project_uuid, 'Product Management System', 'Create product catalog with categories, pricing, stock management, and product details with image support', 'high', 12, 12, 100),
    (project_uuid, 'Enhanced Shopping Cart', 'Implement cart context with add/remove/update functionality, local storage persistence, and real-time cart updates', 'critical', 10, 10, 100),
    (project_uuid, 'Checkout Flow Implementation', 'Build comprehensive checkout process with customer information forms, order summary, and validation', 'high', 8, 8, 100),
    (project_uuid, 'Order Processing & Success', 'Create order creation system with order tracking, success pages, and order history management', 'high', 6, 6, 100),
    (project_uuid, 'Search & Navigation', 'Implement product search functionality, category browsing, and improved navigation experience', 'medium', 4, 4, 100),
    (project_uuid, 'User Experience & Polish', 'Enhance UI/UX with responsive design, loading states, error handling, and visual improvements', 'medium', 6, 6, 100);
